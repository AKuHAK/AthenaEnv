...
static const JSCFunctionListEntry color_funcs[] = {
    JS_CFUNC_DEF("new", -1, athena_color_ctor), JS_CFUNC_DEF("getR", 1, athena_getR),
    JS_CFUNC_DEF("getG", 1, athena_getG),       JS_CFUNC_DEF("getB", 1, athena_getB),
    JS_CFUNC_DEF("getA", 1, athena_getA),       JS_CFUNC_DEF("setR", 2, athena_setR),
    JS_CFUNC_DEF("setG", 2, athena_setG),       JS_CFUNC_DEF("setB", 2, athena_setB),
