...
static const JSCFunctionListEntry render_funcs[] = {
    JS_CFUNC_DEF("init", 1, athena_initrender), JS_CFUNC_DEF("loadOBJ", 2, athena_loadobj),
    JS_CFUNC_DEF("drawOBJ", 7, athena_drawobj), JS_CFUNC_DEF("drawBbox", 8, athena_drawbbox),
