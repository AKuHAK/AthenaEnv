...
static const JSCFunctionListEntry module_funcs[] = {
    JS_CFUNC_DEF("point", 3, athena_point_draw),       JS_CFUNC_DEF("line", 5, athena_line_draw),
    JS_CFUNC_DEF("triangle", 9, athena_triangle_draw), JS_CFUNC_DEF("quad", 12, athena_quad_draw),
    JS_CFUNC_DEF("rect", 5, athena_rect_draw),         JS_CFUNC_DEF("circle", 5, athena_circle_draw)};
